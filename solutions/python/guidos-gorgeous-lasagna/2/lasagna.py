...
This module will assist in calculating the total time required to
prepare the lasagna, the time left for lasagna in the oven, and 
the total time spent in the kitchen so far.
"""
